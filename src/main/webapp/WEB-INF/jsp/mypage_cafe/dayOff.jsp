	...
	<section class="pt-8 pb-2" id="kind">
		<div class="container">
			...
			<div class="d-flex justify-content-between mb-1 border-0 text-center">
				<a href="mypage_member" class="form-control">회원 정보 관리</a> <a
					href="mypageBookingList" class="form-control">예약 관리</a> <a
					href="cafemanage" class="form-control btn-primary">카페 관리</a>
			</div>
		</div>
	</section>
	<!-------------------------- 영업일 관리 창(?) ------------------------------------------>
					...
					<div class="card-body">
						<div class="dayOff-list">
							...
							<ul class="dayOff-item mb-3">
								<li class="dayOff-item-marker"><span
									class="timeline-item-content"> <strong class="fw-bold">
											2022-01-08 </strong> 휴무 <i class="fas fa-times-circle fa-lg"
										style="color: #f00"></i>
								</span></li>
							</ul>
							<!-- dayOff Item 2-->
							<ul class="dayOff-item mb-3">
								<li class="dayOff-item-marker"><span
									class="timeline-item-content"> <strong class="fw-bold">
											2022-01-09 </strong> 10:00 ~ 12:00 일시 정지 <i
										class="fas fa-times-circle fa-lg" style="color: #f00"></i>
								</span></li>
							</ul>
							<!-- dayOff Item 3-->
							<ul class="dayOff-item mb-3">
								<li class="dayOff-item-marker"><span
									class="timeline-item-content"> <strong class="fw-bold">
											2022-01-09 </strong> 14:00 ~ 16:00 4인 테이블 1개 일시 정지 <i
										class="fas fa-times-circle fa-lg" style="color: #f00"></i>
								</span></li>
							</ul>
						</div>
					...
					<div class="cafe-dayOff-time col-7 mb-4">
						...
						<div class="select-time" id="select-time">
							<div class="start-time mb-3">
								<select name="start-time" id="select-start"
									class="form-select select-start w-75">
							...
							<div class="end-time mb-3">
								<select name="end-time" id="select-end"
									class="form-select select-end w-75">
