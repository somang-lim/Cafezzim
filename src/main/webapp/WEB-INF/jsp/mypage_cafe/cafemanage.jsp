		...
		<div class="container">	
				...
				<div class="row align-items-center" id='item'>
					<div class="col-md-6 col-lg-3">
						<a href="${path }/cafeupdate?cafe_id=${vo.cafe_id }" class="location-item card shadow-lg mb-4 border-0" style="height:300px">
							<div class="location-img">
								<img src="img/gallery/${vo.title_photo }" class="img-fluid" alt="서울,경기">
							</div>
